...
$content = <<< INDEX
    <div style="padding-left:16px">
        ...
        <p>
            The current focus of this project is to develop an environmental dashboard which starts with the Chesapeake Bay area
            but eventually grows to encompass the entirety of the US as well as the Bahamas. This dashboard will consist
            of a population tracker for keystone species, water quality levels, air quality, and endangered species tracker.
            For each state, native flora and fauna will be on display as well as an expandable dashboard which can give a detailed
            report on the health of an ecosystem divided by state.
        </p>
    </div>
    <div style="padding-left:16px">
    ...
    <div style="padding-left:16px">
        <h2>The Future</h2>
        <p>
            First and foremost, we need to gather data! Data as far as the eye can see so that it can be processed into meaningful
            graphs and plots. So after the site has been fully converted to PHP, the hunt for data will continue!
        </p>
    </div>
    <div class="centre">
